...
#    print 'ERR: You must not run this program as root!'
#    sys.exit(1)

if not os.path.exists('sinh.cfg'):
    print 'ERROR: Config file is missing!'
    sys.exit(1)

from sinh.core.config import config
import sinh.core.auth
import sinh.core.honeypot
import sinh.core.userauth
import sinh.core.ssh
from sinh import core
...
if cfg.has_option('honeypot', 'interact_enabled') and \
    ...
    from sinh.core import interact
