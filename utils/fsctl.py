...
class fseditCmd(cmd.Cmd):
    ...
    def __init__(self, pickle_file_path):
        ...
        self.intro = "\nsinh file system interactive editor\n" + \
    ...
    def help_about(self):
        print "sinh stores information about its file systems in a " + \
            "series of nested lists. Once the lists are made, they are " + \
            "stored in a pickle file on the hard drive. Every time sinh " + \
            "gets a new client, it reads from the pickle file and loads " + \
            "the fake filesystem into memory. By default this file " + \
            "is /opt/sinh/fs.pickle. Originally the script " + \
            "/opt/sinh/createfs.py was used to copy the filesystem " + \
            ...
            "sinh process in order for the new file system to be " + \
